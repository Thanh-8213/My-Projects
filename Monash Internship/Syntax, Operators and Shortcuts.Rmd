...
This part is a collection of shortcuts, syntax and operators that the author found handy. It saves large amount of time and make the author more productive. It also makes coding with R smoother. In composing this section, the author hope that you can apply the knowledge in here in your future works and projects. 

For the Operator part, you will remember them in no time, so the author leave it here just in case you need a quick reminder. For the base R syntax, they can be quite confusing. However, since they are all over StackOverflow and the internet, you will stumble on them sooner or later. They are old and not used much, and thus are not taught in the course. However, the author figured that knowing the basics of base R may help you with your learning or handling assignments, and solving real-life problems that you will face in the future.  
